pipeline {
    ...
    stages {
        ...
        stage('Stage-3') {
		    ...
		    echo 'Hello World from PipelineRepository from GitHub in Step 1 - Stage 3'
		    echo 'Hello World from PipelineRepository from GitHub in Step 2 - Stage 3'
		    echo 'Hello World from PipelineRepository from GitHub in Step 3 - Stage 3'
